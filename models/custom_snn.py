...
# 2-Layer Heirarchical SNN Using LIF Neurons
class TwoLayerSNN(nn.Module):
...
# 3-Layer Heirarchical SNN Using LIF Neurons
class ThreeLayerSNN(nn.Module):
    ...
    def __init__(
        ...
        self.fc = nn.Sequential(
            HebbianLinearLayer(self.recurrent_dims[2], self.out_dims, **neuron_options['linear_options']),
            get_activation_fn(out_act, out_act_kwargs)
        )
