...
def process_patient(patient_path, img_folder, dataset='nsr', window_length=1, preprocessing_method='neurokit'):
    ...
    # resample to be 360 long per beat
    signal_array, annotation = processing.resample_singlechan(signal_array, annotation, annotation.fs, fs)
...
if __name__ == '__main__':
    ...
    NSR_DATA_DIR = path_configs['mit_bih_nsr_path']
